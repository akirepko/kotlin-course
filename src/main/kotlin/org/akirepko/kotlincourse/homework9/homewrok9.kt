...
fun main()
{
   var wrongAge=145643494
    var wrongDate=456242703
...
fun transfromMessage(message:String):String{
    return when{
        message.contains("С днем рождения")-> message.replace("С днем рождения","Это сейчас, но как бы на следующее день рождение")
        message.startsWith("Займи косарь")-> message.replace("Займи косарь","Перейди по ссылке")
        message.endsWith(".com")->"https://vk$message"
        else->"Не надо это тестировать расслабся"
