package org.example.org.akirepko.kotlincourse.lesson16inheritance
...
fun main() {
    ...
    val abstractFirst=ExtractLast()
    ordinalNumbers.forEach { abstractFirst.addMaterial(it) }

    abstractFirst.printContainer()
    println(abstractFirst.extract())
